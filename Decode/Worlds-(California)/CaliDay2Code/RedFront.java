...
public class RedFront extends LinearOpMode { //SoGoodGonnaBust
    ...
    public void runOpMode() throws InterruptedException { //fixed 🙏BLESS🙏
        ...
        Pose2d Balls1D = new Pose2d(-6, 57, Math.PI*3/2);
        Pose2d Balls2D = new Pose2d(18, 50, Math.PI*3/2);
        Pose2d Balls3D = new Pose2d(40, 65, Math.PI*3/2);
        ...
        TrajectoryActionBuilder back = drive.actionBuilder(afterPose)
                ...
                .splineToLinearHeading(new Pose2d(-6, 32, Math.PI*3/2), Math.PI / 2)

                .setTangent(Math.PI/2)
                .splineToConstantHeading(new Vector2d(-6, 57), Math.PI/2)//eat dem balls
                ;
