...
public class BlueBack extends LinearOpMode { //BackshotsTillBlueBalls
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d firsteatPose = new Pose2d (new Vector2d(-47, -35),  0);//after eating first
        ...
        TrajectoryActionBuilder firsteatballs = drive.actionBuilder(postshootPose) //34
                .setTangent(Math.PI)
                .splineToLinearHeading(new Pose2d(-17, -34.5, 0), Math.PI
                        , new TranslationalVelConstraint(200),null )
                .splineToLinearHeading(new Pose2d(-48, -34.5,  0), Math.PI
        ...
        TrajectoryActionBuilder firstpewballs = drive.actionBuilder(firsteatPose)
                ...
                .splineToSplineHeading(new Pose2d(0, -55, 1.95), 0
                        , new TranslationalVelConstraint(200),null )
                ;

        TrajectoryActionBuilder secondeatballs = drive.actionBuilder(postshootPose) //9
                .setTangent(Math.PI)
                .splineToLinearHeading(new Pose2d(-15, -10, 0), Math.PI
                        , new TranslationalVelConstraint(200 ),null )
                .splineToLinearHeading(new Pose2d(-48, -10, 0), Math.PI
                        , new TranslationalVelConstraint(100),null ) //60
                ;

        TrajectoryActionBuilder secondpewballs = drive.actionBuilder(secondeatPose)
                .setTangent((11*Math.PI)/6)
                .splineToLinearHeading(new Pose2d(0, -55, 1.94), Math.PI*3/2//shoot
                        , new TranslationalVelConstraint(200),null )
                ;
