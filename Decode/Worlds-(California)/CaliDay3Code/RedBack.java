...
public class RedBack extends LinearOpMode { //TheFuriousFapper
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d firsteatPose = new Pose2d (new Vector2d(48, -33.5), Math.PI);//after eating first
        ...
        TrajectoryActionBuilder firsteatballs = drive.actionBuilder(postshootPose)
                .setTangent(0)
                .splineToLinearHeading(new Pose2d(17, -33.5, Math.PI), 0 //y = -34
                        , new TranslationalVelConstraint(200), null)
                .splineToLinearHeading(new Pose2d(48, -33.5, Math.PI), 0
