...
public class RedFront extends LinearOpMode { //SoGoodGonnaBust
    ...
    @Override
    public void runOpMode() throws InterruptedException { //fixed 🙏BLESS🙏
        ...
        // start pose
        Pose2d beginPose = new Pose2d(-45, 52, Math.PI *2.5/ 3.5);
        Pose2d afterPose = new Pose2d(-24, 24, Math.PI *2.5/ 3.5);
        Pose2d Balls1D = new Pose2d(-6.5, 57, Math.PI*3/2);
        Pose2d Balls2D = new Pose2d(18.5, 50, Math.PI*3/2);
        Pose2d Balls3D = new Pose2d(41, 65, Math.PI*3/2);
        ...
        TrajectoryActionBuilder backwards = drive.actionBuilder(beginPose)
                ...
                .splineToLinearHeading(new Pose2d(-24, 24, Math.PI* 2.5 / 3.5 ), Math.PI*7/4)
                .waitSeconds(0.5)
                ;

        TrajectoryActionBuilder back = drive.actionBuilder(afterPose)
                .setTangent(Math.PI*0)
                .splineToLinearHeading(new Pose2d(-6.5, 32, Math.PI*3/2), Math.PI / 2)

                .setTangent(Math.PI/2)
                .splineToConstantHeading(new Vector2d(-6.5, 57), Math.PI/2)//eat dem balls
                ;

        TrajectoryActionBuilder back2 = drive.actionBuilder(afterPose)
                .setTangent(Math.PI*0)
                .splineToLinearHeading(new Pose2d(18, 34, Math.PI*3/2 ), Math.PI/6)

                .setTangent(Math.PI/2)
                .splineToConstantHeading(new Vector2d(18, 60), Math.PI/2)

                .setTangent(Math.PI/2)
                .splineToConstantHeading(new Vector2d(18, 50), Math.PI*3/2)
                ;

        TrajectoryActionBuilder back3 = drive.actionBuilder(afterPose)
                .setTangent(Math.PI*0)
                .splineToLinearHeading(new Pose2d(40, 34, Math.PI*3/2 ), Math.PI/6)
        ...
        TrajectoryActionBuilder reset = drive.actionBuilder(Balls1D) //shoot 1
                ...
                .splineToLinearHeading(new Pose2d(-24, 24, Math.PI* 2.5 / 3.5 ), Math.PI*5/4)//reset to pos
                .waitSeconds(1)
                ;

        TrajectoryActionBuilder reset2 = drive.actionBuilder(Balls2D) //shoot 2
                .setTangent(Math.PI)
                .splineToLinearHeading(new Pose2d(-24, 24, Math.PI* 2.5 / 3.5 ), Math.PI)//reset to pos
                .waitSeconds(1)
                ;

        TrajectoryActionBuilder reset3 = drive.actionBuilder(Balls3D) //shoot 3 + park
                .setTangent(Math.PI*3/2)
                .splineToLinearHeading(new Pose2d(-24, 24, Math.PI*2.5/3.5 ), Math.PI, new TranslationalVelConstraint(200), null)//reset to pos
                .waitSeconds(1)
