...
@Config
@Autonomous(name = "BlueBB", group = "Autonomous")
public class BackshotsTillBlueBalls extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d postshootPose = new Pose2d (new Vector2d(0, -55),1.9);//after shooting
        Pose2d firsteatPose = new Pose2d (new Vector2d(-47, -34),  0);//after eating first
        Pose2d secondeatPose = new Pose2d (new Vector2d(-47, -10), 0);//after eat second
        ...
        TrajectoryActionBuilder firsteatballs = drive.actionBuilder(postshootPose) //34
                .setTangent(Math.PI)
                .splineToLinearHeading(new Pose2d(-17, -35, 0), Math.PI
                        , new TranslationalVelConstraint(160),null )
                .splineToLinearHeading(new Pose2d(-48, -35,  0), Math.PI
                        , new TranslationalVelConstraint(50),null )
                ;

        TrajectoryActionBuilder firstpewballs = drive.actionBuilder(firsteatPose)
                .setTangent((11*Math.PI)/6)
                .splineToSplineHeading(new Pose2d(0, -55, 1.9), 0
                        , new TranslationalVelConstraint(160),null )
                ;
        ...
        TrajectoryActionBuilder secondpewballs = drive.actionBuilder(secondeatPose)
                .setTangent((11*Math.PI)/6)
                .splineToLinearHeading(new Pose2d(0, -55, 1.95), Math.PI*3/2//shoot
                        , new TranslationalVelConstraint(160),null )
                ;
        ...
        TrajectoryActionBuilder hpeatballs = drive.actionBuilder(postshootPose)
                ...
                .splineToLinearHeading(new Pose2d(-46, -43, Math.PI/5), Math.PI
                        , new TranslationalVelConstraint(160),null )
                .setTangent(3*Math.PI/2)
                .splineToLinearHeading(new Pose2d(-46, -60, Math.PI/5), 3*Math.PI/2
                        , new TranslationalVelConstraint(20.0),null )
        ...
        TrajectoryActionBuilder hppewballs = drive.actionBuilder(hpeatPose)
                .setTangent((11*Math.PI)/6)
                .splineToLinearHeading(new Pose2d(-2, -55, 1.92), Math.PI*3/2
                        , new TranslationalVelConstraint(160),null )
                ;
