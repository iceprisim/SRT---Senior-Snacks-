...
@Config
@Autonomous(name = "LimeLight back", group = "Autonomous")
//@Disabled
public class b_b_Backshots extends LinearOpMode {
    ...
    public class Shooter {
        ...
        public class Shoot1 implements Action {
            ...
            public boolean run(@NonNull TelemetryPacket packet) {
                shooterLeft.setPower(0.100);
                shooterRight.setPower(0.100);
                return false;
            }
        }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //build trajectories :)
        TrajectoryActionBuilder freePoints = drive.actionBuilder(beginPose) //this trajectory shoots first 3 then aligns to scan april tag
                .setTangent(Math.PI)
                .splineToLinearHeading(new Pose2d(-24, 0, Math.PI), 0);
