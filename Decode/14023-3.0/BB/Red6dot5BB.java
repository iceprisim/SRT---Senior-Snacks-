...
@Config
@Autonomous(name = "Red6dot5BB", group = "Autonomous")
public class Red6dot5BB extends LinearOpMode {
    ...
    public class Shooter {
        ...
        public class Shoot1 implements Action{
            ...
            public boolean run(@NonNull TelemetryPacket packet){
                shooterLeft.setPower(0.562);
                shooterRight.setPower(0.562);
                return false;
            }
        }
        public Action Shoot1 () {
            return new Red6dot5BB.Shooter.Shoot1();
        }
    ...
    public class Spinner {
        ...
        public Action intake(){
            return new Red6dot5BB.Spinner.intake();
        }
        ...
        public Action intakeStop(){
            return new Red6dot5BB.Spinner.intakeStop();
        }
    }
    public class Conveyor {
        ...
        public Action convUp () {
            return new Red6dot5BB.Conveyor.convUp();
        }
        ...
        public Action convStop () {
            return new Red6dot5BB.Conveyor.convStop();
        }
    }
    public class ShooterAngle {
        ...
        public Action angle1() {
            return new Red6dot5BB.ShooterAngle.angle1();
        }
        ...
        public class angle2 implements Action{
            @Override
            public boolean run(@NonNull TelemetryPacket packet){
                shootAngle.setPosition(0.172);
                return false;
            }
        }
        public Action angle2() {
            return new Red6dot5BB.ShooterAngle.angle2();
        }
    }
    public class BlockControl {
        ...
        public Action blockOff() {
            return new Red6dot5BB.BlockControl.blockOff();
        }
        ...
        public Action blockOn() {
            return new Red6dot5BB.BlockControl.blockOn();
        }
    }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d postshoot0Pose = new Pose2d (new Vector2d(0, -50),1.2);//after shooting preloaded (3)
        Pose2d posteat1Pose = new Pose2d (new Vector2d(56, -20), Math.PI);//after intaking first (3)
        Pose2d postshoot1Pose = new Pose2d (new Vector2d(-5, -55), 1.2);//after shooting first (6)
        ...
        TrajectoryActionBuilder firsteatballs = drive.actionBuilder(postshoot0Pose)
                .splineToLinearHeading(new Pose2d(20, -26, Math.PI), Math.PI/4 )
                .waitSeconds(0.1)
                .splineToLinearHeading(new Pose2d(54, -26, Math.PI), Math.PI )
                .waitSeconds(0.1);

        TrajectoryActionBuilder firstpewballs = drive.actionBuilder(posteat1Pose)
                .splineToSplineHeading(new Pose2d(-5, -55, 1.23), Math.PI);

        TrajectoryActionBuilder secondeatballs = drive.actionBuilder(postshoot0Pose)
                .splineToLinearHeading(new Pose2d(26, 0, Math.PI), Math.PI/4)
                .waitSeconds(0.1)
                .splineToLinearHeading(new Pose2d(54, 0 , Math.PI), Math.PI)
                .waitSeconds(0.1)
                .splineToLinearHeading(new Pose2d(26, 0, Math.PI), Math.PI);
