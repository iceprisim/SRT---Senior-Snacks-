...
@Config
@Autonomous(name = "Blue6BB", group = "Autonomous")
public class Blue6BB extends LinearOpMode {
    ...
    public class Shooter {
        ...
        public Action Shoot1 () {
            return new Blue6BB.Shooter.Shoot1();}

        public class Shoot2 implements Action{

            @Override
            public boolean run(@NonNull TelemetryPacket packet){
                shooterLeft.setPower(0.58);
                shooterRight.setPower(0.58);
                return false;
            }
        }
        public Action Shoot2 () {
            return new Blue6BB.Shooter.Shoot2();
        }
    ...
    public class Spinner {
        ...
        public Action intake(){
            return new Blue6BB.Spinner.intake();
        }
        ...
        public Action intakeStop(){
            return new Blue6BB.Spinner.intakeStop();
        }
    }
    public class Conveyor {
        ...
        public Action convUp () {
            return new Blue6BB.Conveyor.convUp();
        }
        ...
        public Action convStop () {
            return new Blue6BB.Conveyor.convStop();
        }
    }
    public class ShooterAngle {
        ...
        public class angle1 implements Action{
            @Override
            public boolean run(@NonNull TelemetryPacket packet){
                shootAngle.setPosition(0.174);
                return false;
            }
        }
        public Action angle1() {
            return new Blue6BB.ShooterAngle.angle1();
        }
        ...
        public Action angle2() {
            return new Blue6BB.ShooterAngle.angle2();
        }
    }
    public class BlockControl {
        ...
        public Action blockOff() {
            return new Blue6BB.BlockControl.blockOff();
        }
        ...
        return new Blue6BB.BlockControl.blockOn();
    }
    }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d postprePose = new Pose2d (new Vector2d(0, -50),2.08);//after shooting preloaded (3)
        ...
        TrajectoryActionBuilder firsteatballs = drive.actionBuilder(postprePose)
                .splineToLinearHeading(new Pose2d(-15, -26, -0.1), Math.PI )
                .waitSeconds(0.1)
                .splineToLinearHeading(new Pose2d(-58, -26, 0), Math.PI )
                .waitSeconds(0.1);

        TrajectoryActionBuilder firstpewballs = drive.actionBuilder(posteat1Pose)
                .splineToSplineHeading(new Pose2d(10, -60, 1.92), 0);


        TrajectoryActionBuilder park = drive.actionBuilder(postprePose)
                .splineToLinearHeading(new Pose2d(-25, -45, -0.2), Math.PI)
                .waitSeconds(0.2);
