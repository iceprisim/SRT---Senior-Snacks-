...
@Config
@Autonomous(name = "OBlueAutoBB", group = "Autonomous")
public class OBlueAutoBB extends LinearOpMode {
    ...
    public class Shooter {
        ...
        public class Shoot1 implements Action{
            ...
            public boolean run(@NonNull TelemetryPacket packet){
                shooterLeft.setPower(0.71);
                shooterRight.setPower(0.71);
                return false;
            }
        }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder Sideways = drive.actionBuilder(beginPose)
                .splineToSplineHeading(new Pose2d(3.5, 10, 0.45), Math.PI / 2);
