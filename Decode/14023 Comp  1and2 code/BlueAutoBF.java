...
public class BlueAutoBF extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder forward = drive.actionBuilder(beginPose)
                .setTangent(0)
                .splineToSplineHeading(new Pose2d(80, -35, 0.8), 0);

        TrajectoryActionBuilder reset = drive.actionBuilder(
                        new Pose2d(new Vector2d(80, -35), 0.8))
                .splineToSplineHeading(new Pose2d(80, -35, 0.8), 0)
                .waitSeconds(10);
