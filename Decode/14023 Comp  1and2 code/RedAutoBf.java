...
@Config
@Autonomous(name = "RedAutoBf", group = "Autonomous")
public class RedAutoBF extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder forward = drive.actionBuilder(beginPose)
                .splineToSplineHeading(new Pose2d(100, -15, -0.9), Math.PI / 2);

        TrajectoryActionBuilder sleep = drive.actionBuilder(
                        new Pose2d(new Vector2d(100, -15), -0.9))
                .waitSeconds(10);
