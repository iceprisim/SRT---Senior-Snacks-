...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2675.5500527951754; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2688.5731826705223; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 660.8949036043293; // x position of the perpendicular encoder (in tick units)
    }
